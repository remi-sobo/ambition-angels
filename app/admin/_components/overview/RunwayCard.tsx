...
// Runway hero — the one number that should dominate the CEO's screen. Runway =
// cash on hand / trailing-3-month average burn. Amber under 3 months, critical
// under 1.5 (spec's locked thresholds).
  ...
  return (
    <section className="bg-tile shadow-tile border-[1.5px] border-outline rounded-card-lg overflow-hidden">
      ...
      <div className="p-5 grid grid-cols-1 lg:grid-cols-[auto,1fr] gap-6 items-center">
        <div>
          <div className="text-[11px] uppercase tracking-wider text-ink-3 font-semibold mb-1">Months of runway</div>
          ...
          <div className="mt-3 grid grid-cols-2 gap-x-6 gap-y-1 text-sm">
            ...
            <span className="text-ink-1 font-semibold text-right [font-variant-numeric:tabular-nums]">{money(d.burn3mo)}</span>
            <span className="text-ink-3 text-[11px] col-span-2 mt-0.5">burn = trailing 3-month average expense</span>
          </div>
        </div>
