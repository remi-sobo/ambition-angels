...
// the org holds the `aa.demoday` entitlement; otherwise the not-authorized
// panel. Direct URL hits are covered here — sidebar hiding alone is cosmetic.
export default function DemodayLayout({ children }: { children: ReactNode }) {
  return (
    <FeatureGate feature="aa.demoday" label="Demo Day">
      {children}
    </FeatureGate>
  );
}
