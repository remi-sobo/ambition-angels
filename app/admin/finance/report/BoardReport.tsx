...
//
// Extracted at Spec Finance N3: the V1 route renders it unmodified
// (byte-identical) and the Reports screen hosts it at ?view=board — the
// /admin/finance/report 308 (ACTIVE since B2) lands on Reports, one click
...
export default async function BoardReport() {
