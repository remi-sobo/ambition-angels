  ...
  return (
    <div className="min-h-screen bg-ink">
      ...
      <div className="max-w-[1100px] mx-auto px-4 sm:px-6 lg:px-10 py-6 lg:py-8 space-y-6">
                ...
                return (
                  <li key={g.id} className="px-5 py-4">
                    <div className="flex items-center gap-4 flex-wrap">
                      <span className="font-bold text-cream [font-variant-numeric:tabular-nums] w-24">
                        {money(g.amount)}
                      </span>
                      <div className="min-w-0 flex-1">
                        <div className="text-sm text-cream/90 font-medium truncate">
        ...
        <p className="text-xs text-gray-mid leading-relaxed max-w-2xl">
