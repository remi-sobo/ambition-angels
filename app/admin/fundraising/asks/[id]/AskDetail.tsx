...
//
// Extracted at Spec Fundraising F6: the asks map row is a PREFIX row, so
// /admin/fundraising/asks/<id> 308s to /admin/fundraising/pipeline/<id> at
// cutover — that seat renders this same component (v2=true: back-link to
// the Pipeline screen). The V1 route renders it unmodified, byte-identical.
...
export default async function AskDetail({ id, v2 = false }: { id: string; v2?: boolean }) {
    ...
    <div className="min-h-screen bg-ink">
      <div className="max-w-[1100px] px-4 lg:px-8 py-6 lg:py-8 space-y-6">
        <PageHeader
          eyebrow={
            <Link
              href={v2 ? "/admin/fundraising/pipeline" : "/admin/fundraising/asks"}
