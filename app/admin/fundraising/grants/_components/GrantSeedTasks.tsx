...
export default function GrantSeedTasks({ grantId }: { grantId: string }) {
  ...
  return (
    <div className="bg-tile border-hairline rounded-panel-lg p-5 flex flex-col sm:flex-row sm:items-center gap-3">
      ...
      <button
        onClick={seed}
        disabled={busy}
        className="bg-orange hover:bg-orange-dark disabled:opacity-50 text-white text-sm font-semibold px-4 py-2 rounded-control whitespace-nowrap self-start sm:self-auto"
      >
