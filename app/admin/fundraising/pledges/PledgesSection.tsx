...
// (embedded=false — output byte-identical to the pre-N2 page) and
// Finance → Forecast embeds it as the pledges-due tier — the map has said
// pledges land there since Stage 0, and its row activates at N4.
...
export default async function PledgesSection({ embedded = false }: { embedded?: boolean }) {
  ...
  return (
    <div className={embedded ? undefined : "min-h-screen bg-ink"}>
      <div className={embedded ? "space-y-4" : "max-w-[1400px] px-4 lg:px-8 py-6 lg:py-8 space-y-6"}>
        {embedded ? (
          <div>
