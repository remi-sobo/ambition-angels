...
// The Monday plan ritual — orient, carryover, areas, days, commit — over
// rhythm_sessions + ops_tasks, with the real agenda behind the day board.
//
// Extracted at Spec Work W1: the V1 route (/admin/ops/monday) renders it
