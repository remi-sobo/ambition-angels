...
// the org holds the `ai.reed` entitlement; otherwise the not-authorized
// panel. Direct URL hits are covered here — sidebar hiding alone is cosmetic.
export default function ReedLayout({ children }: { children: ReactNode }) {
  return (
    <FeatureGate feature="ai.reed" label="Reed">
      {children}
    </FeatureGate>
  );
}
