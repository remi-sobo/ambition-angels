...
// the org holds the `aa.ygb` entitlement; otherwise the not-authorized
// panel. Direct URL hits are covered here — sidebar hiding alone is cosmetic.
export default function YgbLayout({ children }: { children: ReactNode }) {
  return (
    <FeatureGate feature="aa.ygb" label="YGB Camp">
      {children}
    </FeatureGate>
  );
}
