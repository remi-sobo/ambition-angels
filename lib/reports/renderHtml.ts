/**
 * The shared report artifact renderer (generalized out of
 * lib/finance/reportExport.ts at Spec Impact I2, decision 2 — RESOLVED:
 * Finance and Impact share the machinery, not the screen; finance
 * re-exports these names so its importers and its exported HTML are
 * untouched, byte for byte). PURE (the export routes feed it live data;
